...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/napari-roi-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15220&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/napari-roi-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `napari-roi` can be installed with:

```
conda install napari-roi
```

It is possible to list all of the versions of `napari-roi` available on your platform with:
